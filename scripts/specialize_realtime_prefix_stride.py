...
SUMMARY_KEYS = [
    ...
    "corrections",
    "corrections_per_min",
    "draft_ready_latency_ms_avg",
    "draft_ready_latency_ms_p95",
    "final_confirmed_ready_latency_ms_avg",
    "final_confirmed_ready_latency_ms_p95",
    "draft_onset_latency_ms_avg",
    "draft_onset_latency_ms_p95",
    "final_confirmed_onset_latency_ms_avg",
    "final_confirmed_onset_latency_ms_p95",
]
PRIMARY_TO_P95 = {
    "draft_ready_latency_ms_avg": "draft_ready_latency_ms_p95",
    "final_confirmed_ready_latency_ms_avg": "final_confirmed_ready_latency_ms_p95",
}
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="draft_ready_latency_ms_avg",
...
def _aggregate_candidate(
    ...
    aggregate = {
        ...
        "draft_ready_latency_ms_avg_mean": _mean(_series(runs, "draft_ready_latency_ms_avg")),
        "draft_ready_latency_ms_avg_stdev": _stdev(_series(runs, "draft_ready_latency_ms_avg")),
        "draft_ready_latency_ms_p95_mean": _mean(_series(runs, "draft_ready_latency_ms_p95")),
        "final_confirmed_ready_latency_ms_avg_mean": _mean(_series(runs, "final_confirmed_ready_latency_ms_avg")),
        "final_confirmed_ready_latency_ms_avg_stdev": _stdev(_series(runs, "final_confirmed_ready_latency_ms_avg")),
        "final_confirmed_ready_latency_ms_p95_mean": _mean(_series(runs, "final_confirmed_ready_latency_ms_p95")),
        "draft_onset_latency_ms_avg_mean": _mean(_series(runs, "draft_onset_latency_ms_avg")),
        "final_confirmed_onset_latency_ms_avg_mean": _mean(_series(runs, "final_confirmed_onset_latency_ms_avg")),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    fieldnames = [
        ...
        "corrections_max",
        "corrections_total",
        "draft_ready_latency_ms_avg_mean",
        "draft_ready_latency_ms_avg_stdev",
        "draft_ready_latency_ms_p95_mean",
        "final_confirmed_ready_latency_ms_avg_mean",
        "final_confirmed_ready_latency_ms_avg_stdev",
        "final_confirmed_ready_latency_ms_p95_mean",
        "draft_onset_latency_ms_avg_mean",
        "final_confirmed_onset_latency_ms_avg_mean",
        "primary_metric",
        "primary_metric_mean",
