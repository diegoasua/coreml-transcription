...
SUMMARY_KEYS = [
    ...
    "confirmed_ready_latency_ms_avg",
    "confirmed_ready_latency_ms_p95",
...
PRIMARY_TO_P95 = {
    ...
    "confirmed_ready_latency_ms_avg": "confirmed_ready_latency_ms_p95",
}
...
def _aggregate_candidate(
    ...
    aggregate = {
        ...
        "confirmed_ready_latency_ms_avg_mean": _mean(_series(runs, "confirmed_ready_latency_ms_avg")),
        "confirmed_ready_latency_ms_avg_stdev": _stdev(_series(runs, "confirmed_ready_latency_ms_avg")),
        "confirmed_ready_latency_ms_p95_mean": _mean(_series(runs, "confirmed_ready_latency_ms_p95")),
...
def _write_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    fieldnames = [
        ...
        "confirmed_ready_latency_ms_avg_mean",
        "confirmed_ready_latency_ms_avg_stdev",
        "confirmed_ready_latency_ms_p95_mean",
